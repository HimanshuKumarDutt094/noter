...
export function HomePage() {
  ...
  const currentTab = (searchParams.get("tab") === "projects" ? "projects" : "notes") as "notes" | "projects";
    ...
    <div className="relative">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <TabsContent value="notes" className="mt-0">
          <Suspense fallback={<div className="p-4 text-sm text-muted-foreground">Loading notes…</div>}>
            <NotesPage />
          </Suspense>
        </TabsContent>
        <TabsContent value="projects" className="mt-0">
          <Suspense fallback={<div className="p-4 text-sm text-muted-foreground">Loading projects…</div>}>
            <ProjectsPage />
          </Suspense>
        </TabsContent>
      </Tabs>
